...
**No mod should require the client to install anything**
*Only enhance the experience if they want to mod their client.*
...
- [ModernFix](https://github.com/coredex-source/ModernFix---mVUS)
- [Noisium](https://github.com/offbeat-stuff/noisium)
- [ScalableLux](https://modrinth.com/mod/scalablelux)
- [ServerCore](https://modrinth.com/mod/servercore)
- [ThreadTweak](https://modrinth.com/mod/threadtweak)
- [Very Many Player](https://modrinth.com/mod/vmp-fabric)
...
### QoL
- [Armor Quick Swap](https://modrinth.com/mod/armor-quick-swap)
- [Death Back Potion](https://modrinth.com/datapack/death-back-potion)
- [Double Doors]
- [Echo Compass](https://modrinth.com/datapack/echo-compass)
...
- [Recall Potion](https://modrinth.com/datapack/ly-recall-potion)
- [Replanting Crops]
...
- [MVS](https://modrinth.com/mod/moogs-voyager-structures)

#### Nether
- [Amplified Nether](https://modrinth.com/mod/amplified-nether)
- [Amplified Nether Height]
- [D&T Nether Fortress Overhaul]
- [Formations Nether]
- [Hearths]
